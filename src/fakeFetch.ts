import { TFlight } from './Redux/features/flightsSlice/types'
...
const mockResponse: TMockResponse = {
  status: 200,
  data: {
    flights: [
      {
...
export const fetchMockData = (url: string): Promise<TMockResponse> => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      if (isError) {
        reject('Error occurred while fetching mock data')
      } else {
